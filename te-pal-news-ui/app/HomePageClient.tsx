...
export default function HomePageClient() {
  ...
  const showSkeleton = loading && !hasPosts
  const showError = error && !hasPosts
  const showContent = hasPosts || !loading
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-6 space-y-6">
      ...
      {showContent && hotTopic && <HotTopicHero post={hotTopic} />}
      {showContent && <WeeklyBestTop3 posts={weeklyBest} />}
      {showContent && (
        <>
